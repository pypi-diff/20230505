# Comparing `tmp/DXR-1.8.1.tar.gz` & `tmp/DXR-1.8.2.tar.gz`
...
### Comparing `DXR-1.8.1/Dxr_Chat/utils.py` & `DXR-1.8.2/Dxr_Chat/utils.py`
...
### Comparing `DXR-1.8.1/dxr_cli/cli.py` & `DXR-1.8.2/dxr_cli/cli.py`
