# Comparing `tmp/pyroporn-0.0.4.tar.gz` & `tmp/pyroporn-0.0.5.tar.gz`
...
### Comparing `pyroporn-0.0.4/pyroporn/database/othDatabase.py` & `pyroporn-0.0.5/pyroporn/database/othDatabase.py`
