# Comparing `tmp/verify_access_autoconf-0.1.0.tar.gz` & `tmp/verify_access_autoconf-0.2.0.tar.gz`
...
### Comparing `verify_access_autoconf-0.1.0/src/verify_access_autoconf/__init__.py` & `verify_access_autoconf-0.2.0/src/verify_access_autoconf/__init__.py`
...
### Comparing `verify_access_autoconf-0.1.0/src/verify_access_autoconf/util/configure_util.py` & `verify_access_autoconf-0.2.0/src/verify_access_autoconf/util/configure_util.py`
...
### Comparing `verify_access_autoconf-0.1.0/src/verify_access_autoconf/util/data_util.py` & `verify_access_autoconf-0.2.0/src/verify_access_autoconf/util/data_util.py`
...
### Comparing `verify_access_autoconf-0.1.0/src/verify_access_autoconf/webseal.py` & `verify_access_autoconf-0.2.0/src/verify_access_autoconf/webseal.py`
