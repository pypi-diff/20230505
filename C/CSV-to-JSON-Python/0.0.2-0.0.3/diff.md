# Comparing `tmp/CSV to JSON Python-0.0.2.tar.gz` & `tmp/CSV to JSON Python-0.0.3.tar.gz`
...
## Comparing `CSV to JSON Python-0.0.2.tar` & `CSV to JSON Python-0.0.3.tar`
...
### Comparing `CSV to JSON Python-0.0.2/LICENSE.txt` & `CSV to JSON Python-0.0.3/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `CSV to JSON Python-0.0.2/PKG-INFO` & `CSV to JSON Python-0.0.3/PKG-INFO`
...
### Comparing `CSV to JSON Python-0.0.2/setup.cfg` & `CSV to JSON Python-0.0.3/setup.cfg`
...
### Comparing `CSV to JSON Python-0.0.2/setup.py` & `CSV to JSON Python-0.0.3/setup.py`
...
### Comparing `CSV to JSON Python-0.0.2/src/CSV_to_JSON_Python.egg-info/PKG-INFO` & `CSV to JSON Python-0.0.3/src/CSV_to_JSON_Python.egg-info/PKG-INFO`
