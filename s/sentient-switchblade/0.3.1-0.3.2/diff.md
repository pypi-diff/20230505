# Comparing `tmp/sentient_switchblade-0.3.1.tar.gz` & `tmp/sentient_switchblade-0.3.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "sentient_switchblade-0.3.1.tar", max compression
+gzip compressed data, was "sentient_switchblade-0.3.2.tar", max compression
```

## Comparing `sentient_switchblade-0.3.1.tar` & `sentient_switchblade-0.3.2.tar`

### file list

```diff
@@ -1,18 +1,18 @@
--rw-r--r--   0        0        0     1077 2023-04-25 19:36:38.976660 sentient_switchblade-0.3.1/LICENSE
--rw-r--r--   0        0        0     8349 2023-05-04 19:24:10.174736 sentient_switchblade-0.3.1/README.md
--rw-r--r--   0        0        0     1781 2023-05-04 22:32:30.563720 sentient_switchblade-0.3.1/pyproject.toml
--rw-r--r--   0        0        0        0 2023-04-25 19:36:27.260808 sentient_switchblade-0.3.1/src/switchbladecli/__init__.py
--rw-r--r--   0        0        0        0 2023-04-25 19:35:52.447291 sentient_switchblade-0.3.1/src/switchbladecli/cli/__init__.py
--rw-r--r--   0        0        0     1491 2023-05-04 19:17:19.432214 sentient_switchblade-0.3.1/src/switchbladecli/cli/__main__.py
--rw-r--r--   0        0        0    11501 2023-05-04 21:09:34.637478 sentient_switchblade-0.3.1/src/switchbladecli/cli/bundle_cache.py
--rw-r--r--   0        0        0     1725 2023-05-01 18:05:13.432197 sentient_switchblade-0.3.1/src/switchbladecli/cli/config.py
--rw-r--r--   0        0        0      677 2023-05-04 22:29:41.057878 sentient_switchblade-0.3.1/src/switchbladecli/cli/lint.py
--rw-r--r--   0        0        0      683 2023-05-04 20:39:52.194670 sentient_switchblade-0.3.1/src/switchbladecli/cli/test.py
--rw-r--r--   0        0        0      479 2023-05-04 20:41:51.180130 sentient_switchblade-0.3.1/src/switchbladecli/cli/update.py
--rw-r--r--   0        0        0      256 2023-05-04 22:00:04.840133 sentient_switchblade-0.3.1/src/switchbladecli/exceptions.py
--rw-r--r--   0        0        0        0 2023-04-26 17:36:55.033765 sentient_switchblade-0.3.1/src/switchbladecli/modes/__init__.py
--rw-r--r--   0        0        0    11587 2023-05-04 22:32:02.105086 sentient_switchblade-0.3.1/src/switchbladecli/modes/python_poetry.py
--rw-r--r--   0        0        0      415 2023-05-04 22:00:19.685629 sentient_switchblade-0.3.1/src/switchbladecli/modes/tool_runner.py
--rw-r--r--   0        0        0      848 2023-05-04 21:04:15.624544 sentient_switchblade-0.3.1/src/switchbladecli/utils.py
--rw-r--r--   0        0        0     9555 1970-01-01 00:00:00.000000 sentient_switchblade-0.3.1/setup.py
--rw-r--r--   0        0        0     9756 1970-01-01 00:00:00.000000 sentient_switchblade-0.3.1/PKG-INFO
...
### Comparing `sentient_switchblade-0.3.1/LICENSE` & `sentient_switchblade-0.3.2/LICENSE`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.3.1/README.md` & `sentient_switchblade-0.3.2/README.md`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.3.1/pyproject.toml` & `sentient_switchblade-0.3.2/pyproject.toml`
...
### Comparing `sentient_switchblade-0.3.1/src/switchbladecli/cli/__main__.py` & `sentient_switchblade-0.3.2/src/switchbladecli/cli/__main__.py`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.3.1/src/switchbladecli/cli/bundle_cache.py` & `sentient_switchblade-0.3.2/src/switchbladecli/cli/bundle_cache.py`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.3.1/src/switchbladecli/cli/config.py` & `sentient_switchblade-0.3.2/src/switchbladecli/cli/config.py`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.3.1/src/switchbladecli/cli/lint.py` & `sentient_switchblade-0.3.2/src/switchbladecli/cli/lint.py`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.3.1/src/switchbladecli/cli/test.py` & `sentient_switchblade-0.3.2/src/switchbladecli/cli/test.py`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.3.1/src/switchbladecli/modes/python_poetry.py` & `sentient_switchblade-0.3.2/src/switchbladecli/modes/python_poetry.py`
...
### Comparing `sentient_switchblade-0.3.1/src/switchbladecli/utils.py` & `sentient_switchblade-0.3.2/src/switchbladecli/utils.py`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.3.1/setup.py` & `sentient_switchblade-0.3.2/setup.py`
...
@@ -1,14 +1,14 @@
 ...
 {'console_scripts': ['swb = switchbladecli.cli.__main__:switchbladecli']}
-setup_kwargs = { 'name': 'sentient-switchblade', 'version': '0.3.1',
...
### Comparing `sentient_switchblade-0.3.1/PKG-INFO` & `sentient_switchblade-0.3.2/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: sentient-switchblade Version: 0.3.1 Summary:
