# Comparing `tmp/edc-0.4.87.tar.gz` & `tmp/edc-0.4.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "edc-0.4.87.tar", last modified: Fri May  5 04:29:40 2023, max compression
+gzip compressed data, was "edc-0.4.9.tar", last modified: Mon Aug 15 01:45:03 2022, max compression
```

## Comparing `edc-0.4.87.tar` & `edc-0.4.9.tar`

### file list

```diff
@@ -1,75 +1,72 @@
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-05-05 04:29:40.266258 edc-0.4.87/
--rw-r--r--   0 erikvw     (501) staff       (20)     1410 2022-05-03 03:22:05.000000 edc-0.4.87/.gitignore
--rw-r--r--   0 erikvw     (501) staff       (20)     1076 2023-02-28 00:26:10.000000 edc-0.4.87/.pre-commit-config.yaml
--rw-r--r--   0 erikvw     (501) staff       (20)      291 2022-08-08 18:50:02.000000 edc-0.4.87/.yamllint
--rw-r--r--   0 erikvw     (501) staff       (20)        0 2022-05-03 03:22:05.000000 edc-0.4.87/AUTHORS
--rw-r--r--   0 erikvw     (501) staff       (20)    38786 2023-05-05 04:29:32.000000 edc-0.4.87/CHANGES
--rw-r--r--   0 erikvw     (501) staff       (20)    35147 2020-03-07 14:11:38.000000 edc-0.4.87/LICENSE
--rw-r--r--   0 erikvw     (501) staff       (20)      151 2020-03-07 14:11:38.000000 edc-0.4.87/MANIFEST.in
--rw-r--r--   0 erikvw     (501) staff       (20)    38295 2023-05-05 04:29:40.266362 edc-0.4.87/PKG-INFO
--rw-r--r--   0 erikvw     (501) staff       (20)    37432 2022-11-29 06:04:52.000000 edc-0.4.87/README.rst
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-05-05 04:29:40.253124 edc-0.4.87/bin/
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-05-05 04:29:40.256281 edc-0.4.87/bin/nginx/
--rw-r--r--   0 erikvw     (501) staff       (20)      350 2022-07-30 01:15:42.000000 edc-0.4.87/bin/nginx/edc-sites.conf
--rw-r--r--   0 erikvw     (501) staff       (20)      706 2022-07-30 01:15:42.000000 edc-0.4.87/bin/nginx/edc-uat.conf
--rw-r--r--   0 erikvw     (501) staff       (20)      656 2022-07-30 01:15:42.000000 edc-0.4.87/bin/nginx/edc.conf
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-05-05 04:29:40.256988 edc-0.4.87/bin/scripts/
--rw-r--r--   0 erikvw     (501) staff       (20)     2753 2022-10-05 21:50:32.000000 edc-0.4.87/bin/scripts/dev_repos.sh
--rw-r--r--   0 erikvw     (501) staff       (20)      276 2020-03-07 14:11:38.000000 edc-0.4.87/bin/scripts/list_db_files.sh
--rw-r--r--   0 erikvw     (501) staff       (20)      416 2020-03-07 14:11:38.000000 edc-0.4.87/bin/scripts/restore_db_file.sh
--rw-r--r--   0 erikvw     (501) staff       (20)     2408 2022-07-30 01:15:42.000000 edc-0.4.87/bin/scripts/update_edc.sh
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-05-05 04:29:40.258150 edc-0.4.87/bin/systemd/
--rw-r--r--   0 erikvw     (501) staff       (20)      835 2020-03-07 14:11:38.000000 edc-0.4.87/bin/systemd/celery-uat.service
--rw-r--r--   0 erikvw     (501) staff       (20)      820 2020-03-07 14:11:38.000000 edc-0.4.87/bin/systemd/celery.service
--rw-r--r--   0 erikvw     (501) staff       (20)      501 2020-03-07 14:11:38.000000 edc-0.4.87/bin/systemd/celerybeat-uat.service
--rw-r--r--   0 erikvw     (501) staff       (20)      487 2020-03-07 14:11:38.000000 edc-0.4.87/bin/systemd/celerybeat.service
--rw-r--r--   0 erikvw     (501) staff       (20)      485 2020-03-07 14:11:38.000000 edc-0.4.87/bin/systemd/gunicorn-uat.service
--rw-r--r--   0 erikvw     (501) staff       (20)      121 2020-03-07 14:11:38.000000 edc-0.4.87/bin/systemd/gunicorn-uat.socket
--rw-r--r--   0 erikvw     (501) staff       (20)      474 2020-03-07 14:11:38.000000 edc-0.4.87/bin/systemd/gunicorn.service
--rw-r--r--   0 erikvw     (501) staff       (20)      111 2020-03-07 14:11:38.000000 edc-0.4.87/bin/systemd/gunicorn.socket
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-05-05 04:29:40.262036 edc-0.4.87/docs/
--rw-r--r--   0 erikvw     (501) staff       (20)      634 2022-09-26 00:00:10.000000 edc-0.4.87/docs/Makefile
--rw-r--r--   0 erikvw     (501) staff       (20)    12969 2023-01-25 02:44:13.000000 edc-0.4.87/docs/README.rst
--rw-r--r--   0 erikvw     (501) staff       (20)     4441 2022-07-30 01:15:42.000000 edc-0.4.87/docs/backup.rst
--rw-r--r--   0 erikvw     (501) staff       (20)
txt
--rw-r--r--   0 erikvw     (501) staff       (20)       86 2022-07-30 01:15:42.000000 edc-0.4.87/requirements.tests/test_utils.txt
--rw-r--r--   0 erikvw     (501) staff       (20)      238 2022-08-23 12:40:42.000000 edc-0.4.87/requirements.tests/third_party_dev.txt
--rw-r--r--   0 erikvw     (501) staff       (20)       50 2022-05-03 03:22:05.000000 edc-0.4.87/requirements.tests/tox.txt
--rw-r--r--   0 erikvw     (501) staff       (20)     2994 2023-05-05 04:29:40.266762 edc-0.4.87/setup.cfg
-drwxr-xr-x   0 erikvw     (501) staff       (20)        0 2023-05-05 04:29:40.266032 edc-0.4.87/utils/
--rw-r--r--   0 erikvw     (501) staff       (20)        0 2021-02-09 03:49:51.000000 edc-0.4.87/utils/__init__.py
--rw-r--r--   0 erikvw     (501) staff       (20)      721 2022-05-03 03:22:05.000000 edc-0.4.87/utils/get_edc_requirements.py
...
### Comparing `edc-0.4.87/.gitignore` & `edc-0.4.9/.gitignore`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/.pre-commit-config.yaml` & `edc-0.4.9/.pre-commit-config.yaml`
...
### Comparing `edc-0.4.87/CHANGES` & `edc-0.4.9/CHANGES`
...
### Comparing `edc-0.4.87/LICENSE` & `edc-0.4.9/LICENSE`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/PKG-INFO` & `edc-0.4.9/PKG-INFO`
...
### Comparing `edc-0.4.87/README.rst` & `edc-0.4.9/edc.egg-info/PKG-INFO`
...
### Comparing `edc-0.4.87/bin/nginx/edc-uat.conf` & `edc-0.4.9/bin/nginx/edc-uat.conf`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/bin/nginx/edc.conf` & `edc-0.4.9/bin/nginx/edc.conf`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/bin/scripts/dev_repos.sh` & `edc-0.4.9/bin/scripts/dev_repos.sh`
...
### Comparing `edc-0.4.87/bin/scripts/update_edc.sh` & `edc-0.4.9/bin/scripts/update_edc.sh`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/bin/systemd/celery-uat.service` & `edc-0.4.9/bin/systemd/celery-uat.service`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/bin/systemd/celery.service` & `edc-0.4.9/bin/systemd/celery.service`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/docs/backup.rst` & `edc-0.4.9/docs/backup.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/docs/celery.rst` & `edc-0.4.9/docs/celery.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/docs/conda.rst` & `edc-0.4.9/docs/conda.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/docs/configure_web_services.rst` & `edc-0.4.9/docs/configure_web_services.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/docs/deploy_new_droplet.rst` & `edc-0.4.9/docs/deploy_new_droplet.rst`
...
### Comparing `edc-0.4.87/docs/exporting_encrypted_data.rst` & `edc-0.4.9/docs/exporting_encrypted_data.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/docs/forms_reference.md` & `edc-0.4.9/docs/forms_reference.md`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/docs/landing_page.rst` & `edc-0.4.9/docs/landing_page.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/docs/printing.rst` & `edc-0.4.9/docs/printing.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/docs/update_deployment.rst` & `edc-0.4.9/docs/update_deployment.rst`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/edc.egg-info/PKG-INFO` & `edc-0.4.9/README.rst`
...
### Comparing `edc-0.4.87/edc.egg-info/SOURCES.txt` & `edc-0.4.9/edc.egg-info/SOURCES.txt`
...
### Comparing `edc-0.4.87/edc.egg-info/requires.txt` & `edc-0.4.9/edc.egg-info/requires.txt`
...
### Comparing `edc-0.4.87/image/icon-pycharm.png` & `edc-0.4.9/image/icon-pycharm.png`

 * *Files identical despite different names*

### Comparing `edc-0.4.87/requirements.tests/edc.txt` & `edc-0.4.9/requirements.tests/edc.txt`
...
### Comparing `edc-0.4.87/requirements.tests/edc_dev.txt` & `edc-0.4.9/requirements.tests/edc_dev.txt`
...
### Comparing `edc-0.4.87/setup.cfg` & `edc-0.4.9/setup.cfg`
...
### Comparing `edc-0.4.87/utils/get_edc_requirements.py` & `edc-0.4.9/utils/get_edc_requirements.py`
