# Comparing `tmp/carchive-0.0.42.tar.gz` & `tmp/carchive-0.0.43.tar.gz`
...
## Comparing `carchive-0.0.42.tar` & `carchive-0.0.43.tar`
...
### Comparing `carchive-0.0.42/LICENSE` & `carchive-0.0.43/LICENSE`

 * *Files identical despite different names*

### Comparing `carchive-0.0.42/carchive/__init__.py` & `carchive-0.0.43/carchive/__init__.py`

 * *Files identical despite different names*

### Comparing `carchive-0.0.42/setup.py` & `carchive-0.0.43/setup.py`
