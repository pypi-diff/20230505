# Comparing `tmp/fps_frontend-0.1.5.tar.gz` & `tmp/fps_frontend-0.1.6.tar.gz`

## Comparing `fps_frontend-0.1.5.tar` & `fps_frontend-0.1.6.tar`
...
### Comparing `fps_frontend-0.1.5/.gitignore` & `fps_frontend-0.1.6/.gitignore`

 * *Files identical despite different names*

### Comparing `fps_frontend-0.1.5/COPYING.md` & `fps_frontend-0.1.6/COPYING.md`

 * *Files identical despite different names*

### Comparing `fps_frontend-0.1.5/pyproject.toml` & `fps_frontend-0.1.6/pyproject.toml`
