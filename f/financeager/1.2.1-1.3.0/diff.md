# Comparing `tmp/financeager-1.2.1.tar.gz` & `tmp/financeager-1.3.0.tar.gz`
...
### Comparing `financeager-1.2.1/examples/quickstart.svg` & `financeager-1.3.0/examples/quickstart.svg`
